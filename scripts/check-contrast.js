...
const PAIRS = [
  ...
  ['--ink-soft', '--surface-2', '보조 글자 / 알약', 4.5],
  ['--ink', '--surface-2', '본문 글자 / 알약', 4.5],
  // 흐린 글자는 배경뿐 아니라 얹히는 모든 면에서 본문 기준을 지켜야 합니다.
  // 처음엔 배경만 재다가 카드 위에서 4.03:1 인 것을 놓쳤습니다.
  ['--ink-mute', '--bg', '흐린 글자 / 배경', 4.5],
  ['--ink-mute', '--surface', '흐린 글자 / 카드', 4.5],
  ['--ink-mute', '--surface-2', '흐린 글자 / 알약', 4.5],
